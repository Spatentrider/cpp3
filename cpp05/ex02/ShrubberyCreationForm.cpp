...
Shrubbery::Shrubbery() : AForm("Shrubbery", 145, 137), _target("Shrubbery") 
{
	// std::cout << "Shrubbery: constructor called" << std::endl;
}

Shrubbery::Shrubbery(const std::string& target) : AForm("Shrubbery_" + target, 145, 137), _target(target) 
{
